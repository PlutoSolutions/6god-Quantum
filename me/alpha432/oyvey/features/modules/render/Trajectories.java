...
public class Trajectories extends Module
{
    ...
    public Setting<Integer> slices;
    public Setting<Integer> size;
    public Setting<Integer> innerSize;
    ...
    public Trajectories() {
        ...
        this.slices = (Setting<Integer>)this.register(new Setting("Slices", (T)3, (T)3, (T)100));
        this.size = (Setting<Integer>)this.register(new Setting("Size", (T)1, (T)(-5), (T)5));
        this.innerSize = (Setting<Integer>)this.register(new Setting("Inner Size", (T)1, (T)(-5), (T)5));
    }
