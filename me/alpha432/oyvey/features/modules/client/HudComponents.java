...
public class HudComponents extends Module
{
    ...
    public void drawImageLogo() {
        ...
        HudComponents.mc.getTextureManager().bindTexture(HudComponents.logo);
        drawCompleteImage(this.imageX.getValue(), this.imageY.getValue(), this.imageWidth.getValue(), this.imageHeight.getValue());
        HudComponents.mc.getTextureManager().deleteTexture(HudComponents.logo);
    ...
    static {
        box = new ResourceLocation("textures/gui/container/shulka_box.png");
        HudComponents.logo = new ResourceLocation("textures/quantum.png");
    }
