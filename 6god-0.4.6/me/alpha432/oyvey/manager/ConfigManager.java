...
public class ConfigManager implements Util
{
    ...
    public void loadConfig(final String name) {
        final List<File> files = Arrays.stream((Object[])Objects.requireNonNull((T[])new File("Quantum").listFiles())).filter(File::isDirectory).collect((Collector<? super Object, ?, List<File>>)Collectors.toList());
    ...
    public void saveCurrentConfig() {
        final File currentConfig = new File("Quantum/currentconfig.txt");
        try {
