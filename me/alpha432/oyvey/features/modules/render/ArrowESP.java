...
public class ArrowESP extends Module
{
    ...
    public ArrowESP() {
        ...
        this.rainbow = (Setting<Boolean>)this.register(new Setting("NiggerTest", (T)false));
            ...
            if (o instanceof EntityPlayer && this.isValid(o)) {
                ...
                if (pos != null && !this.isOnScreen(pos) && !RenderUtil.isInViewFrustrum((Entity)entity)) {
                    if (this.rainbow.getValue()) {
                        ...
                        new Color(OyVey.INSTANCE.getColorManager().getColor().getRed(), OyVey.INSTANCE.getColorManager().getColor().getGreen(), OyVey.INSTANCE.getColorManager().getColor().getBlue(), (int)MathHelper.clamp(255.0f - 255.0f / this.fadeDistance.getValue() * ArrowESP.mc.player.getDistance((Entity)entity), 100.0f, 255.0f));
                    }
                    else {
